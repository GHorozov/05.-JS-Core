function classHierarhy() {
    class Figure {
        constructor() {
            if (new.target === Figure) {
                throw new Error('This is abstarct class and cannot be initialize!');
            }
        }
    ...
    class Circle extends Figure {
        ...
        toString(){
            ...
            return parentToString + ` - radius: ${this.radius}`;
        }
    }
    ...
    class Rectangle extends Figure{
        ...
        toString(){
            let parentToString = super.toString();
            return parentToString + ` - width: ${this.width}, height: ${this.height}`;
        }
    }
