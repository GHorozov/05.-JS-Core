...
let rgbToHexColor =require('../06. RGB to Hex.js');

describe('RBGToHex tests', function () {
    ...
    it('Should return undefined -1,0,0', function () {
        expect(rgbToHexColor(-1,0,0)).to.be.equal(undefined);
    });
    it('Should return undefined 0,-1,0', function () {
        expect(rgbToHexColor(0,-1,0)).to.be.equal(undefined);
    });
    it('Should return undefined 0,0,-1', function () {
    ...
    it('Should return undefined 3.14,0,0', function () {
        expect(rgbToHexColor(3.14,0,0)).to.be.equal(undefined);
    });
    it('Should return undefined 0,3.14,0', function () {
        expect(rgbToHexColor(0,3.14,0)).to.be.equal(undefined);
    });
    it('Should return undefined 0,0,3.14', function () {
